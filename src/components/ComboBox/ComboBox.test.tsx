...
describe("ComboBox tests:", () => {
  ...
  beforeEach(() => {
    renderWithTheme(<ComboBox {...comboBoxProps} />);
  ...
  it("When ComboBox is called, then select an item message is rendered", () => {
    const text = screen.getByText(/Select an item/i);
    expect(text).toBeInTheDocument();
  });

  it("When ComboBox is called, then chevron down icon is rendered", () => {
    const icon = screen.getByTestId("ChevronDown");
    expect(icon).toBeInTheDocument();
  });

  it("When ComboBox, then listitem isn't rendered", () => {
